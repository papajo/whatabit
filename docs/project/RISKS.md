...
| --- | --- | --- | --- | --- | --- |
| R-001 | Download engine writes incomplete files as if complete. | High | Medium | Gate final flush on completion; add stopped/incomplete state; document partial output behavior. | Open |
